var game = new Phaser.Game(530, 530, Phaser.CANVAS, 'Auto', {preload: preload, create: create, update: update});

function preload(){
    game.load.image('auto', 'imagen/nave2.png');
    game.load.image('espacio', 'imagen/fondostar.png');
}
